package com.awsproserve.kinesis.advance.connectorlibraryprocessed;
...
import com.awsproserve.kinesis.advance.consumer.LangAndTime;
import com.awsproserve.kinesis.advance.consumer.TwitterAnalyticsDb;
...
public class TweeetsCounterPipeline implements IRecordProcessor {
    // Fake DB
    ...
    private void processTweet(Status status) {
        // get the language of the tweet by calling tweeter get lang method
        String tweetLanguage = status.getLang();
        // here is where increments are happening (word counts)
    ...
    public void shutdown(ShutdownInput shutdownInput) {
        ...
        switch (reason) {
            case TERMINATE:
            case REQUESTED:
                //before someone request terminate we will save statistics
                saveStatistics();
